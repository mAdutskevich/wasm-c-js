...
var Module = typeof loadMath != 'undefined' ? loadMath : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_substract')) {
        Object.defineProperty(Module['ready'], '_substract', { configurable: true, get: function() { abort('You are getting _substract on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_substract', { configurable: true, set: function() { abort('You are setting _substract on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('math.wasm', import.meta.url).toString();
}
...
run();
  ...
  return loadMath.ready
}
);
})();
export default loadMath;